...
import {
  ...
  ResidentUser,
} from "../../residents/services/residents.service";
...
const PropertyDetailPage = () => {
  ...
  const [viewingResident, setViewingResident] = useState<ResidentUser | null>(
    null,
  );
  ...
  const handleUpdate = async (data: any) => {
    ...
    try {
      ...
      if (res.success) {
        dispatch(
          showToast({ message: "Propiedad actualizada", type: "success" }),
        );
      ...
      dispatch(
        showToast({ message: "Error al actualizar propiedad", type: "error" }),
      );
    }
  };
    ...
    () => [
      ...
      },
      {
        ...
        render: (row: ResidentUser) => {
          ...
          return (
            <div
              className={`flex items-center gap-1.5 font-bold text-xs uppercase tracking-wider ${row.role === "OWNER" ? "text-amber-600" : "text-emerald-600"}`}
            >
              {row.role === "OWNER" ? (
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-500 font-medium">
            Cargando expediente de propiedad...
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center bg-white p-10 rounded-3xl shadow-xl max-w-sm border border-slate-100">
          ...
          <p className="text-slate-500 mb-8">
            El registro solicitado no existe o ha sido eliminado del catálogo.
          </p>
          <ITButton
            color="primary"
  ...
  const statusKey =
    typeof property.status === "object"
      ...
      : property.status;
  const status = (statusKey && statusMap[statusKey]) || {
    label: "DESCONOCIDO",
    color: "secondary",
  };
                ...
                <div>
                  ...
                  <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100/50">
                    ...
                    {property.betweenStreets && (
                      <>
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 mt-4">
                          Entre calles / Ref.
                        </p>
                  ...
                  <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-700 mt-1 leading-relaxed">
                        No hay una geolocalización vinculada para visualizar el
                        mapa.
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Gestiona los habitantes vinculados a este expediente
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:w-[40%] bg-white p-10 border-r border-slate-100 flex flex-col">
            <div className="flex items-start justify-between mb-10">
              <div className="relative">
                <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-emerald-400 to-emerald-600 text-white flex items-center justify-center text-3xl font-black shadow-xl shadow-emerald-100 ring-4 ring-white">
                  ...
                  {viewingResident?.lastName?.charAt(0)}
                </div>
              ...
              <ITBadget
                ...
                variant="filled"
                color={
                  viewingResident?.role === "OWNER" ? "warning" : "success"
                }
              >
                {viewingResident?.role === "OWNER"
                  ? "PROPIETARIO"
                  : "RESIDENTE"}
              </ITBadget>
            </div>
            ...
            <div className="space-y-8 flex-1">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-slate-700">
                        {viewingResident?.residentProfile?.phoneNumber ||
                          "No registrado"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <p className="text-sm font-bold text-slate-700 truncate max-w-[180px]">
                        {viewingResident?.residentProfile?.email ||
                          "No registrado"}
                      </p>
                    </div>
                  </div>
              ...
              <div className="relative p-6 rounded-[2rem] bg-gradient-to-br from-red-500 to-red-600 shadow-xl shadow-red-100 overflow-hidden">
                <FaExclamationTriangle
                  ...
                  size={120}
                />
                <h4 className="text-[10px] font-black text-red-100 uppercase tracking-[0.2em] mb-4">
                  Protocolo Emergencia
                </h4>
                <div className="space-y-4 relative z-10">
                  <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                    <p className="text-[10px] font-bold text-red-100 uppercase tracking-widest opacity-80">
                      Contacto Responsable
                    </p>
                    <p className="text-md font-bold text-white mb-1">
                      {viewingResident?.residentProfile?.emergencyContact ||
            ...
            <div className="mt-10">
              <ITButton
                ...
                className="w-full text-slate-400 hover:text-slate-800 py-4 font-bold border-2 border-slate-100 hover:border-slate-300 rounded-2xl transition-all"
              >
          ...
          <div className="flex-1 p-10 lg:p-14 bg-gradient-to-b from-slate-50 to-white overflow-y-auto max-h-[85vh]">
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                <p className="text-slate-400 text-sm font-medium">
                  Expediente de identidad oficial y verificación
                </p>
              </div>
            ...
            {viewingResident?.residentProfile?.ineFrontUrl ||
            viewingResident?.residentProfile?.ineBackUrl ? (
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                {[
                  {
                    label: "Identificación Anversa",
                    url: viewingResident.residentProfile.ineFrontUrl,
                    id: "front",
                  },
                  {
                    label: "Identificación Reversa",
                    url: viewingResident.residentProfile.ineBackUrl,
                    id: "back",
                  },
                ].map(
                  (doc) =>
              ...
              <div className="flex flex-col items-center justify-center p-20 bg-white rounded-[3rem] border-2 border-dashed border-slate-200 text-slate-400 text-center shadow-inner">
                ...
                <h5 className="text-xl font-black text-slate-700">
                  Sin Documentación
                </h5>
                <p className="text-sm max-w-[280px] mt-2 font-medium">
                  Este residente aún no ha completado la carga de su
                  identificación oficial en el sistema.
                </p>
              </div>
            )}
            ...
            {viewingResident?.residentProfile?.notes && (
              <div className="mt-12 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-4 relative z-10">
                  ...
                  <h4 className="font-black text-slate-800 tracking-tight uppercase text-xs">
