...
const IncidentCreateForm = ({ isOpen, onClose, onSuccess, categoriesCatalog, typesCatalog }: IncidentCreateFormProps) => {
                ...
                {categoriesCatalog.map(cat => {
                  ...
                  return (
                    <button
                      ...
                      style={isSelected ? { backgroundColor: cat.color || '#0d9488' } : undefined}
                    >
                      {cat.value}
                    </button>
                  );
