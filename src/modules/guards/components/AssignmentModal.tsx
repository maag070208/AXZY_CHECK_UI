  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        dispatch(
          showToast({ message: "Error al crear asignación", type: "error" }),
        );
      }
    } catch (error: any) {
      dispatch(
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
            ...
            {tasks.length > 0 ? (
              ...
              <p className="text-[11px] text-slate-400 italic text-center py-2 font-medium tracking-wide">
                No se han definido consignas especiales
              </p>
            )}
          </div>
