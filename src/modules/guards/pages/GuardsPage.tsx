...
import { QuickRoleModal } from "../components/QuickRoleModal";
        ...
        <ITDataTable
          ...
          columns={[
            ...
            },
            {
              ...
              render: (row: any) => {
                const roleName =
                  typeof row.role === "object" ? row.role.name : "";
                const roleValue =
                ...
                return (
                  <div className="flex items-center">
                    <span
                      className={`px-2.5 py-1 font-black text-[10px] rounded-lg border uppercase tracking-widest ${colorClass}`}
                    >
                      {roleValue}
                    </span>
                  </div>
              ...
              actions: (row: any) => (
                <div className="flex items-center gap-2">
                  <ITButton
                    ...
                    size="small"
                    variant="outlined"
                    className="border-slate-200 text-slate-500 hover:bg-slate-50 !rounded-lg"
                    title="Ver Tareas"
                  >
                    <FaEye />
                  </ITButton>
