...
export const CreateRouteModal = ({
  ...
  const availableLocations = allLocations.filter(
    (l) => !addedLocations.find((al) => al.locationId === l.id),
  );
        ...
        <div className="lg:w-1/3 flex flex-col gap-8 border-r border-slate-100 pr-6 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden mt-2">
            <div className="flex items-center justify-between mb-5">
              ...
              >
                {selectedGuards.length === allGuards.length
                  ? "Limpiar Selección"
                  : "Marcar Todos"}
              </button>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-center gap-1">
                        <div
                          className={`w-1 h-1 rounded-full ${selectedGuards.includes(guard.id) ? "bg-[#065911]" : "bg-slate-300"}`}
                        />
